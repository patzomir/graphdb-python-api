...
from graphdb.graphdb_workbench.models.user_details import UserDetails  # noqa: E501
...
class TestUserDetails(unittest.TestCase):
    ...
    def testUserDetails(self):
        ...
        # model = graphdb.graphdb_workbench.models.user_details.UserDetails()  # noqa: E501
        pass
